...
export const NAVIGATION_CONFIG = {
  [ROLES.COORDINATOR]: [
    ...
    { label: "NAAC Criteria", path: "/criteria", icon: Award },
    { label: "Documents & Evidence", path: "/documents", icon: UploadCloud },
    { label: "Submissions", path: "/submissions", icon: FileText },
    { label: "Review & Approval", path: "/review", icon: CheckSquare },
  ...
  [ROLES.ADMIN]: [
    ...
    { label: "Institution Management", path: "/admin/institutions", icon: Building },
...
export const getNavigationForRole = (roleStr) => {
  ...
  return NAVIGATION_CONFIG[normalized] || NAVIGATION_CONFIG[ROLES.COORDINATOR];
};
